...
import { ExternalLink, ChevronLeft, ChevronRight, TrendingUp, X } from "lucide-react"; // Importei o X
  ...
  return (
    <section id="projetos" ref={ref} className="py-24 bg-secondary/5">
      <div className="container mx-auto px-4">
        {/* HEADER e FILTROS (sem alterações) */}
        <motion.div
      ...
      <Dialog open={!!selectedProject} onOpenChange={() => setSelectedProject(null)}>
        <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto bg-card border-border p-0 gap-0">
          {/* Botão X explícito para Mobile no topo */}
          ...
          {selectedProject && (
            <div className="flex flex-col">
              ...
              <div className="p-6 md:p-8 space-y-8">
                {/* Título e Descrição (sem alterações) */}
                <div>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  <div className="bg-secondary/30 rounded-xl p-6 flex flex-col justify-center space-y-4 border border-border/50">
                    ...
                    {/* NOVO: Botão Fechar explícito para Mobile no final */}
                    <div className="md:hidden pt-2 border-t border-border/50">
                      <Button
                        variant="ghost"
                        onClick={() => setSelectedProject(null)}
                        className="w-full text-muted-foreground hover:text-foreground hover:bg-background/50 h-10"
                      >
                        Fechar Detalhes
                      </Button>
                    </div>
