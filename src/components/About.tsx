        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative w-full aspect-square max-w-md mx-auto">
              ...
              <img
                src="/placeholder.svg"
                alt="Erick - Especialista em Automação"
                className="relative rounded-full border-4 border-primary/20 shadow-2xl w-full h-full object-cover"
              />
            </div>
          </motion.div>
              ...
              <div className="flex flex-wrap gap-2">
                {technologies.map((tech, index) => (
                  ...
                  >
                    <Badge
                      variant="secondary"
                      className="bg-primary/10 text-primary border-primary/20 hover:bg-primary/20 transition-colors px-4 py-1.5"
                    >
                      {tech}
                    </Badge>
                  </motion.div>
